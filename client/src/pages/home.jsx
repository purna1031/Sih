  ...
  return (
    <>
      <Box
        ...
        p={0}
      >
        <Container maxW="container.lg" backgroundColor="black" centerContent>
          <Stack spacing={6} textAlign="center">
            ...
            >
            Let's connect with Alumni..</Button>
          </Stack>
        </Container>
      </Box><hr />
        <br/>
        ...
        <Container maxW="container.lg">
          ...
          >
            ...
            <Card>
              ...
              <CardBody>
                <Text>Alumni can intimate the students about how to approach for a job in certain domain.</Text>
              </CardBody>
            </Card>
            <Card>
              <CardHeader>
